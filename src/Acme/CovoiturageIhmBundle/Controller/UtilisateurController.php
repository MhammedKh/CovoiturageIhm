...
use Acme\CovoiturageIhmBundle\Entity\Utilisateur;
use Acme\CovoiturageIhmBundle\Form\UtilisateurType;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCovoiturageIhmBundle:Utilisateur')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeCovoiturageIhmBundle:Utilisateur:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCovoiturageIhmBundle:Utilisateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeCovoiturageIhmBundle:Utilisateur:edit.html.twig")
     */
