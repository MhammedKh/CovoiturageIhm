...
use Acme\CovoiturageIhmBundle\Entity\Annonce;
use Acme\CovoiturageIhmBundle\Form\AnnonceType;
...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCovoiturageIhmBundle:Annonce')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeCovoiturageIhmBundle:Annonce:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCovoiturageIhmBundle:Annonce')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeCovoiturageIhmBundle:Annonce:edit.html.twig")
     */
