...
use Acme\CovoiturageIhmBundle\Entity\Reservation;
use Acme\CovoiturageIhmBundle\Form\ReservationType;
...
class ReservationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCovoiturageIhmBundle:Reservation')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeCovoiturageIhmBundle:Reservation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCovoiturageIhmBundle:Reservation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeCovoiturageIhmBundle:Reservation:edit.html.twig")
     */
